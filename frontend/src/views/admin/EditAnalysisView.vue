...
import { formatText, generateUrlMediaHtml, generateFileMediaHtml, parseReferenceLinks, parseMeta } from '@/utils/analysisUtils.js';
  ...
  try {
    ...
    form.value = {
      ...
      coverImage:      a.cover_image_path
        ...
        : null,
      entry_type:      safeText(a.entry_type) || 'analysis',
